//Question 1 : Write a program to copy the contents of a file named source.txt to a new file 
//named destination.txt. Check if the source file exists before copying. 
